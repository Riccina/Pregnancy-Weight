...
shinyUI(
        ...
        sidebarLayout(
                sidebarPanel(
                        ...
                        sliderInput("Weight","Your weight in kg:",min=0,max=220,value=60),
                        sliderInput("Height","Your height in cm:",min=0,max=220,value=170)
                            ),
                mainPanel(
                        ...
                        font-si16pt;color:darkgray;size:15px") 
